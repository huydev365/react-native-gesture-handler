...
export declare const longPressGestureHandlerProps: readonly [
  'minDurationMs',
  'maxDist'
];
...
export declare const LongPressGestureHandler: import('react').ComponentType<
  LongPressGestureHandlerProps & import('react').RefAttributes<any>
>;
