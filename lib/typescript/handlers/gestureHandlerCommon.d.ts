...
export declare const baseGestureHandlerProps: readonly [
  'id',
  'enabled',
...
export declare type GestureUpdateEvent<
  GestureEventPayloadT = Record<string, unknown>
> = GestureEventPayload & GestureEventPayloadT;
export declare type GestureStateChangeEvent<
...
export declare type BaseGestureHandlerProps<
...
export declare function filterConfig(
