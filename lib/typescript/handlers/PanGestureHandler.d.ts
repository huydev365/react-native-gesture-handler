...
export declare const panGestureHandlerProps: readonly [
  'activeOffsetY',
  'activeOffsetX',
  'failOffsetY',
  'failOffsetX',
...
export declare const panGestureHandlerCustomNativeProps: readonly [
  'activeOffsetYStart',
  'activeOffsetYEnd',
  'activeOffsetXStart',
  'activeOffsetXEnd',
...
export declare const PanGestureHandler: import('react').ComponentType<
  PanGestureHandlerProps & import('react').RefAttributes<any>
>;
export declare function managePanProps(
