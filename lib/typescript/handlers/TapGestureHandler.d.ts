...
export declare const tapGestureHandlerProps: readonly [
  'maxDurationMs',
  'maxDelayMs',
  'numberOfTaps',
  'maxDeltaX',
...
export declare const TapGestureHandler: import('react').ComponentType<
  TapGestureHandlerProps & import('react').RefAttributes<any>
>;
