...
export declare const forceTouchGestureHandlerProps: readonly [
  'minForce',
  'maxForce',
...
export declare const ForceTouchGestureHandler:
  | typeof ForceTouchFallback
  | React.ComponentType<
      ForceTouchGestureHandlerProps & React.RefAttributes<any>
    >;
export {};
