...
function attachHandlers({ preparedGesture, gestureConfig, gesture, viewTag, useAnimated, }) {
...
export const GestureDetector = (props) => {
    ...
    if (useAnimated) {
        return (<AnimatedWrap ref={viewRef} onGestureHandlerEvent={preparedGesture.animatedEventHandler}>
        {props.children}
      </AnimatedWrap>);
    }
    else {
