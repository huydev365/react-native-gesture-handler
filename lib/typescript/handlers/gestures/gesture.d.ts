...
export declare type GestureRef =
  | number
  | GestureType
...
declare type TouchEventHandlerType = (
  event: GestureTouchEvent,
  stateManager: GestureStateManagerType
) => void;
export declare type HandlerCallbacks<
...
export declare abstract class BaseGesture<
  EventPayloadT extends Record<string, unknown>
> extends Gesture {
  handlerTag: number;
  handlerName: string;
...
export declare abstract class ContinousBaseGesture<
  EventPayloadT extends Record<string, unknown>,
