...
export declare const flingGestureHandlerProps: readonly [
  'numberOfPointers',
  'direction'
];
...
export declare const FlingGestureHandler: import('react').ComponentType<
  FlingGestureHandlerProps & import('react').RefAttributes<any>
>;
